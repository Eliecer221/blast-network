...
(function () {
    ...
    const translations = {
        es: {
            ...
            ref_note: "💡 Tu referido recibe su recompensa cuando el nuevo usuario se registra y compra un mínimo de 10 BLAST.",
        ...
        en: {
            ...
            ref_note: "💡 Referrer receives their reward when the new user registers and purchases a minimum of 10 BLAST.",
